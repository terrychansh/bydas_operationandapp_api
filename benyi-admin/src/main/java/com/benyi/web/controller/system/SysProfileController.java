...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult updatePwd(String oldPassword, String newPassword)
    {
        ...
        {
            return AjaxResult.error("old password is error");
        }
        if (SecurityUtils.matchesPassword(newPassword, password))
        {
            return AjaxResult.error("new password and old password  must be different!");
        }
        ...
        return AjaxResult.error("network exception:1000");
    }
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception
    {
        ...
        {
            LoginUser loginUser = getLoginUser();
            logger.info("===SysProfileController RuoYiConfig.getAvatarPath():"+RuoYiConfig.getAvatarPath());
            logger.info("===SysProfileController file:"+file);
            logger.info("===SysProfileController MimeTypeUtils.IMAGE_EXTENSION:"+MimeTypeUtils.IMAGE_EXTENSION);
